...
- v0.4.0: уведомления фоновых задач и одинаковые инструменты (`specs/003-agent-notices-shared-tools/`) — шаги ленты для `<task-notification>`, перекрытия по приоритету Claude Code вместо «same name», «From Global», копии в других проектах со Same/Differs, плитки-фильтр типов; стенды 7–8 — **реализовано 2026-09-26**
